...
sub new
{
   ...
   $self->AddFields(
      ...
      new kernel::Field::Text(
            name          =>'parent',
            label         =>'Parent',
            weblinkto     =>'otipci::all',
            weblinkon     =>['parent'=>'id'],
            dataobjattr   =>'_source.parent_otip_id'),
      ...
      new kernel::Field::Text(
            ...
            weblinkto     =>'otipci::all',
            weblinkon     =>['child'=>'id'],
            dataobjattr   =>'_source.child_otip_id'),
   ...
   my ($res,$emsg)=$self->ESrestETLload({
        ...
        mappings=>{
         ...
         my $ESjqTransform=
            ...
            "parent_otip_id: .parent.otip_id, ".
            "child_otip_id:  .child.otip_id ".
            "}) ".
            "end ) ".
            "catch (".
            "{ index: { _id: \"__noop__\" } },".
         ...
         if ($session->{loopCount}==0){
            ...
            return($self->ORIGIN_Load_BackCall(
                "/relation?limit=$limit&toffset=$toffset&id.gt=$idgt",
                           $credentialName,$indexname,
                           $ESjqTransform,$opNowStamp,
                $session,$meta)
            );
